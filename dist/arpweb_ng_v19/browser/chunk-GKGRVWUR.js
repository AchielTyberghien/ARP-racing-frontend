...
var formatter = {
   ...
   */
  header: (sig, config2) => {
    if (!isSignal(sig) || (config2 == null ? void 0 : config2.ngSkipFormatting))
      return null;
    let value;
    try {
      value = sig();
...
var VERSION = /* @__PURE__ */ new Version("20.3.13");
...
var CSP_NONCE = new InjectionToken(ngDevMode ? "CSP nonce" : "", {
  ...
  factory: () => {
    var _a7, _b2;
    return ((_b2 = (_a7 = getDocument().body) == null ? void 0 : _a7.querySelector("[ngCspNonce]")) == null ? void 0 : _b2.getAttribute("ngCspNonce")) || null;
  }
});
...
function determineLongestAnimationFromElementAnimations(el, animationsMap, animations) {
  ...
  for (const animation2 of animations) {
    const timing = (_a7 = animation2.effect) == null ? void 0 : _a7.getTiming();
...
function performanceMarkFeature(feature) {
  ...
  (_a7 = performance == null ? void 0 : performance.mark) == null ? void 0 : _a7.call(performance, "mark_feature_usage", { detail: { feature } });
}
...
var EventEmitter_ = class extends Subject {
  constructor(isAsync = false) {
    ...
    if (isInInjectionContext()) {
      this.destroyRef = (_a7 = inject2(DestroyRef, { optional: true })) != null ? _a7 : void 0;
      this.pendingTasks = (_b2 = inject2(PendingTasksInternal, { optional: true })) != null ? _b2 : void 0;
    }
  }
  emit(value) {
    const prevConsumer = setActiveConsumer(null);
...
var _AfterRenderImpl = class _AfterRenderImpl {
  constructor() {
    ...
    __publicField(this, "scheduler", inject2(ChangeDetectionScheduler));
    __publicField(this, "errorHandler", inject2(ErrorHandler, { optional: true }));
  ...
  register(sequence2) {
    ...
    if (view !== void 0) {
      ((_b2 = view[_a7 = AFTER_RENDER_SEQUENCES_TO_ADD]) != null ? _b2 : view[_a7] = []).push(sequence2);
...
function afterEveryRenderImpl(callbackOrSpec, injector, options, once) {
  ...
  const sequence2 = new AfterRenderSequence(manager.impl, getHooks(callbackOrSpec), viewContext == null ? void 0 : viewContext.view, once, destroyRef, tracing == null ? void 0 : tracing.snapshot(null));
...
function createAndRenderEmbeddedLView(declarationLView, templateTNode, context2, options) {
  ...
  try {
    ...
    const embeddedLView = createLView(declarationLView, embeddedTView, context2, viewFlags, null, templateTNode, null, null, (_a7 = options == null ? void 0 : options.injector) != null ? _a7 : null, (_b2 = options == null ? void 0 : options.embeddedViewInjector) != null ? _b2 : null, (_c2 = options == null ? void 0 : options.dehydratedView) != null ? _c2 : null);
...
function getDependenciesForTokenInInjector(token, injector) {
  ...
  if (!(injector instanceof NodeInjector)) {
    return (_c2 = (_b2 = (_a7 = resolverToTokenToDependencies.get(injector)) == null ? void 0 : _a7.get) == null ? void 0 : _b2.call(_a7, token)) != null ? _c2 : [];
  }
  const lView = getNodeInjectorLView(injector);
...
function getInjectorMetadata(injector) {
  ...
  if (injector instanceof R3Injector) {
    return { type: "environment", source: (_a7 = injector.source) != null ? _a7 : null };
  }
...
function getNodesAndEdgesFromSignalMap(signalMap) {
  ...
  for (const [consumer, producers] of signalMap.entries()) {
    ...
    if (isComputedNode(consumer)) {
      ...
      debugSignalGraphNodes.push({
        label: (_e = consumer.debugName) != null ? _e : (_d = (_c2 = (_b2 = (_a7 = consumer.lView) == null ? void 0 : _a7[HOST]) == null ? void 0 : _b2.tagName) == null ? void 0 : _c2.toLowerCase) == null ? void 0 : _d.call(_c2),
        kind: consumer.kind,
        epoch: consumer.version,
...
var _Testability = class _Testability {
  constructor(_ngZone, registry, testabilityGetter) {
    ...
    if (isInInjectionContext()) {
      this._destroyRef = (_a7 = inject2(DestroyRef, { optional: true })) != null ? _a7 : void 0;
    }
...
var _ApplicationInitStatus = class _ApplicationInitStatus {
  constructor() {
    ...
    __publicField(this, "appInits", (_a3 = inject2(APP_INITIALIZER, { optional: true })) != null ? _a3 : []);
...
function triggerHydrationForBlockQueue(injector, hydrationQueue, replayQueuedEventsFn) {
  return __async(this, null, function* () {
    ...
    yield (_a7 = blocksBeingHydrated.get(lastBlockName)) == null ? void 0 : _a7.promise;
...
typeof ((_a4 = document == null ? void 0 : document.documentElement) == null ? void 0 : _a4.getAnimations) === "function";
...
function cancelLeavingNodes(tNode, lView) {
  var _a7;
  const leavingEl = (_a7 = leavingNodes.get(tNode)) == null ? void 0 : _a7.shift();
...
function trackLeavingNodes(tNode, el) {
  ...
  if (leavingNodes.has(tNode)) {
    (_a7 = leavingNodes.get(tNode)) == null ? void 0 : _a7.push(el);
  } else {
...
function addAnimationToLView(animations, tNode, fn) {
  var _a7;
  const nodeAnimations = (_a7 = animations.get(tNode.index)) != null ? _a7 : { animateFns: [] };
...
function animateLeaveClassRunner(el, tNode, lView, classList, renderer, ngZone) {
  ...
  const cleanupFns = [];
  const resolvers = (_a7 = getLViewLeaveAnimations(lView).get(tNode.index)) == null ? void 0 : _a7.resolvers;
...
var LiveCollectionLContainerImpl = class extends LiveCollection {
  ...
  create(index, value) {
    ...
    (_a7 = this.operationsCounter) == null ? void 0 : _a7.recordCreate();
    return embeddedLView;
  }
  destroy(lView) {
    var _a7;
    destroyLView(lView[TVIEW], lView);
    (_a7 = this.operationsCounter) == null ? void 0 : _a7.recordDestroy();
  }
  updateValue(index, value) {
  ...
  reset() {
    ...
    (_a7 = this.operationsCounter) == null ? void 0 : _a7.reset();
  }
  updateIndexes() {
...
function executeWithInvalidateFallback(importMeta, id, callback) {
  ...
  try {
    ...
    if (id !== null && error.message) {
      ...
      (_b2 = (_a7 = importMeta == null ? void 0 : importMeta.hot) == null ? void 0 : _a7.send) == null ? void 0 : _b2.call(_a7, "angular:invalidate", { id, message: toLog, error: true });
    }
    throw e;
  }
}
...
function directiveMetadata(type, metadata) {
  ...
  return {
    ...
    hostDirectives: ((_a7 = metadata.hostDirectives) == null ? void 0 : _a7.map((directive) => typeof directive === "function" ? { directive } : directive)) || null
  };
}
...
var _ChangeDetectionSchedulerImpl = class _ChangeDetectionSchedulerImpl {
  constructor() {
    ...
    __publicField(this, "ngZone", inject2(NgZone));
    __publicField(this, "zonelessEnabled", inject2(ZONELESS_ENABLED));
    __publicField(this, "tracing", inject2(TracingService, { optional: true }));
    __publicField(this, "disableScheduling", (_a5 = inject2(ZONELESS_SCHEDULER_DISABLED, { optional: true })) != null ? _a5 : false);
    ...
    __publicField(this, "scheduleInRootZone", !this.zonelessEnabled && this.zoneIsDefined && ((_c = inject2(SCHEDULE_IN_ROOT_ZONE, { optional: true })) != null ? _c : false));
...
function createViewEffect(view, notifier, fn) {
  ...
  (_b2 = view[_a7 = EFFECTS]) != null ? _b2 : view[_a7] = /* @__PURE__ */ new Set();
...
var _ImagePerformanceWarning = class _ImagePerformanceWarning {
    ...
    if (win) {
      ...
      const setup = () => {
        ...
        if (doc.readyState === "complete") {
          ...
          (_a8 = this.window) == null ? void 0 : _a8.addEventListener("load", waitToScan, { once: true });
        }
      };
      if (typeof Zone !== "undefined") {
        Zone.root.run(() => setup());
  ...
  scanImages() {
    ...
    if (lcpElementFound && !lcpElementLoadedCorrectly && this.lcpImageUrl && !((_c2 = this.options) == null ? void 0 : _c2.disableImageLazyLoadWarning)) {
...
var AFTER_RENDER_PHASE_EFFECT_NODE = /* @__PURE__ */ (() => __spreadProps(__spreadValues({}, SIGNAL_NODE), {
  ...
  phaseFn(previousValue) {
    ...
    try {
      for (const cleanupFn of (_a7 = this.cleanup) != null ? _a7 : EMPTY_CLEANUP_SET) {
        cleanupFn();
      }
    } finally {
...
var AfterRenderEffectSequence = class extends AfterRenderSequence {
  constructor(impl, effectHooks, view, scheduler, injector, snapshot = null) {
    ...
    for (const phase of AFTER_RENDER_PHASES) {
      ...
      node.registerCleanupFn = (fn) => {
        var _a7;
        return ((_a7 = node.cleanup) != null ? _a7 : node.cleanup = /* @__PURE__ */ new Set()).add(fn);
      };
  ...
  destroy() {
    ...
    for (const node of this.nodes) {
      if (node) {
        try {
          for (const fn of (_a7 = node.cleanup) != null ? _a7 : EMPTY_CLEANUP_SET) {
            fn();
          }
        } finally {
...
function afterRenderEffect(callbackOrSpec, options) {
  ...
  const viewContext = injector.get(ViewContext, null, { optional: true });
  const sequence2 = new AfterRenderEffectSequence(manager.impl, [spec.earlyRead, spec.write, spec.mixedReadWrite, spec.read], viewContext == null ? void 0 : viewContext.view, scheduler, injector, tracing == null ? void 0 : tracing.snapshot(null));
  manager.impl.register(sequence2);
  return sequence2;
}
...
@angular/core/fesm2022/core.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-GKGRVWUR.js.map
